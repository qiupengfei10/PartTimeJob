...
public class TaoBaoProductHAdapter extends MyBaseAdapter<TaoBaoBeen.GoodsBean> {
    public TaoBaoProductHAdapter(Context mContext, List<TaoBaoBeen.GoodsBean> data) {
        super(mContext, data);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.item_taobo_product_h,null);
